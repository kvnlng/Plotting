...
113 tests covering: WFDB parsing/decoding (including multi-frequency
...
bookmark store, the per-recording annotation summary, and the
low-rate trend channel discriminator.
